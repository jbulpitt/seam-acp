 ...
 */
function readTunnelUrl(urlFile) {
    try {
 ...
 */
async function pushToGist(gistId, urlFile, logger) {
    ...
    try {
        ...
        if (!res.ok) {
            logger.warn({ status: res.status }, "tunnel-gist: gist update failed");
            return;
        }
 ...
 */
export function startTunnelGistPublisher(gistId, urlFile, logger) {
...
//# sourceMappingURL=tunnel-gist.js.map
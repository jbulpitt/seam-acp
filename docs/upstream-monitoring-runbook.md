...
>
> **Last updated**: 2026-08-19 (daily sweep)
>
...
- [ ] Check [Antigravity CLI releases](https://github.com/google-antigravity/antigravity-cli/releases) — last checked version: **1.1.15** (2026-08-19 sweep; installed = latest; #47, #42, #81 open)
...
- [ ] Check [Claude Code releases](https://github.com/anthropics/claude-code/releases) — last checked version: **2.1.235** (2026-08-19 sweep; installed 2.1.222, upgrade tracked in #40; 2.1.235: spellcheck setting, prompt-cache invalidation fix on language server reconnect, markdown list depth fix, permission dialog fixes, Remote Control improvements, SendMessage oversized-message early reject, Vim mode improvements; #40 updated)
...
- [ ] Check [claude-agent-acp releases](https://github.com/agentclientprotocol/claude-agent-acp/releases) — last checked version: **0.70.0** (2026-08-19 sweep; installed 0.54.1, upgrade tracked in #39; 0.70.0: switch providers for loaded sessions — additive; 0.67.0: model fallback warning advisory — useful for surfacing silent fallbacks in Discord; #39 updated)
...
#### GitHub / Copilot
- [ ] Check [Copilot CLI releases](https://github.com/github/copilot-cli/releases) — last checked version: **1.0.80 stable / 1.0.81-3 pre-release** (2026-08-19 sweep; installed 1.0.80 = stable; 1.0.81-1 adds Gemini 3.7 Flash (#55 confirmed), per-agent usage metrics, ACP allow-all fix, plugin agents in -p mode fix; 1.0.81-2 and -3 are "fixes and changes"; #35, #46, #49, #51, #53, #54, #55 open)

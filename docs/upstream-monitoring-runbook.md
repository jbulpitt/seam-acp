...
>
> **Last updated**: 2026-08-28 (daily sweep)
>
...
- [ ] Check [Antigravity CLI releases](https://github.com/google-antigravity/antigravity-cli/releases) — last checked version: **1.1.22** (2026-08-27 sweep; installed = latest; 1.1.22: added `/model <name>` slug switching, improved `/effort` hint, artifact event coalescing, Gemini API key effort fix, idle CPU reduction, HTTP 502 retry, self subagent drift fix, Windows sharing retry, daemon startup banner cleanup; #42 updated)
...
#### GitHub / Copilot
- [ ] Check [Copilot CLI releases](https://github.com/github/copilot-cli/releases) — last checked version: **1.0.81 stable GA / 1.0.82-0 pre-release** (2026-08-28 sweep; installed 1.0.81 = stable current; 1.0.81 GA: plugins dashboard GA, OpenTelemetry trace context in hooks, Windows WAM auth broker support, stdin token flag; 1.0.82-0 pre-release; upcoming billing/policy changes on Sep 28 and Oct 1)
...
#### Opencode / LM Studio
- [ ] Check [opencode releases](https://github.com/anomalyco/opencode/releases) and npm [`opencode-ai`](https://registry.npmjs.org/opencode-ai/latest) — last checked version: **1.18.25** (2026-08-28 sweep; installed 1.15.13, upgrade tracked in #12; 1.18.25: Azure CLI Entra ID auth without Bun; 1.18.24: Bedrock reasoning response cache fix, Azure CLI Entra ID, V2 config compatibility in V1; #12 updated)
...
#### ACP Protocol
- [ ] Check [ACP SDK npm](https://registry.npmjs.org/@agentclientprotocol/sdk) — current pinned: `^1.1.0`, installed: 1.1.0, latest: **1.4.0** (#28 scope updated to target 1.4.0) — last checked 2026-08-25

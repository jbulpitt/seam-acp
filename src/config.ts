...
export const REMOTE_MAC_MODELS = [
  ...
  { modelId: "gpt-4o-mini-2024-07-18", name: "GPT-4o mini" },
  { modelId: "gpt-4o-2024-11-20", name: "GPT-4o" },
  { modelId: "gpt-4o-2024-08-06", name: "GPT-4o" },
  ...
  { modelId: "gpt-4-1-2025-04-14", name: "GPT-4.1" },
  { modelId: "gpt-5-2", name: "GPT-5.2" },
  { modelId: "gpt-41-copilot", name: "GPT-4.1 Copilot" },
  { modelId: "gpt-3-5-turbo-0613", name: "GPT 3.5 Turbo" },
  { modelId: "gpt-4", name: "GPT 4" },
  { modelId: "gpt-4-0613", name: "GPT 4" },
  { modelId: "gpt-4-0125-preview", name: "GPT 4 Turbo" },
  { modelId: "gpt-4o-2024-05-13", name: "GPT-4o" },
  { modelId: "gpt-4-o-preview", name: "GPT-4o" },

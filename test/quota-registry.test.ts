...
describe("quota polling cadence", () => {
  it("selects the exact per-agent cadence tiers", () => {
    ...
    expect(quotaPollIntervalMs(1)).toBe(60_000);
    expect(quotaPollIntervalMs(2)).toBe(60_000);
    expect(quotaPollIntervalMs(3)).toBe(30_000);
    expect(quotaPollIntervalMs(7)).toBe(30_000);
    expect(quotaPollIntervalMs(8)).toBe(15_000);
    expect(quotaPollIntervalMs(20)).toBe(15_000);
  });
